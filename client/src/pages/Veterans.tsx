...
export default function Veterans() {
  const programs = [
    { id: 1, name: "Athlete to Soldier Transition", desc: "Leverage your athletic discipline for military careers", icon: "🎖️", type: "Career" },
  ...
  const successStories = [
    { name: "Marcus Thompson", branch: "U.S. Army", sport: "Football", now: "NFL Scout", image: "🎖️" },
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="bg-gradient-to-r from-red-500/10 via-white/5 to-blue-500/10 rounded-2xl border border-white/10 p-8 mb-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                { value: "50,000+", label: "Veteran Athletes", icon: "🎖️" },
